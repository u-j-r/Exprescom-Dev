        ...
        for attach in self:
            ...
            if uuid:
                raise ValidationError(_(
                    "You cannot delete documents which contain legal "
                    "information and have been declared to the SAT.\n"
                    "Please, try first to cancel the document associated with "
                    "the record: %s, in the model: %s, named: %s, "
                    "with the UUID: %s; and then resign it if necessary.") % (
